...
class Facility(db.Model):
    ...
    # managerId = db.Column(db.Integer, db.ForeignKey('Manager.id'), nullable=False)
    # for the latter attribute, we need to create a new table with managers ids, their names, and all facilities they are responsable for
    # depending on how we want the code to work
