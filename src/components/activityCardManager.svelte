    ...
    <div class="p-4 py-8 shadow-md rounded-lg border-[1px] border-borderColor ml-auto">
        ...
        <form on:submit|preventDefault={editActivity}>
            ...
            <div class="flex space-x-6 text-[#1A1A1A]">
                ...
                <div class="py-2 flex-1">
                    <label for="time">Activity Day</label> <br>
                    <input class="border-borderColor border-[1px] rounded-md px-2 py-2 mt-1 shadow-sm min-w-full" type="name" id="name" name="name" value="{activityDay}" />
                </div>
            </div>
            ...
            <div class="flex space-x-6 text-[#1A1A1A]">
                <div class="py-2 flex-1">
                    ...
                    <input class="border-borderColor border-[1px] rounded-md px-2 py-2 mt-1 shadow-sm min-w-full" type="time" id="time" name="time" value="{activityStartTime}" />
                </div>
                <div class="py-2 flex-1">
                    <label for="time">End Time</label> <br>
                    <input class="border-borderColor border-[1px] rounded-md px-2 py-2 mt-1 shadow-sm min-w-full" type="time" id="time" name="time" value="{activityEndTime}" />
                </div>
            </div>
            <div class="py-2">
